function [qlike,tres] = cal_quasi_like(param,y,s,m,n,c,Pbullet,restrict);
...
if Pbullet>=0
    [A,K,C,D,Omega] = param2syst(param,s,n,m,c,restrict); 
else
    [A,K,C,D,Omega] = param2syst(param,s,n,m,c,restrict,eye(s)); 
end;
