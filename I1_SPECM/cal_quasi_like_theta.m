function [qlike,tres] = cal_quasi_like_theta(th,y,s,m,n,c,Pbullet,restrict);
% calculates the quasi likelihood for theta structure theta.
%
% SYNTAX: [qlike,tres] = cal_quasi_like_theta(th,y,s,m,n,c,Pbullet,restrict);
%
...
if makcA>0.999999999
    tilA = tilA*0.999999999/makcA;
    tilK = tilK*0.999999999/makcA;
