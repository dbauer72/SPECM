function [qlike,tres] = cal_quasi_like_D(param,th,y,s,m,n,c,Pbullet,restrict);
% calculates the quasi likelihood for theta structure theta.
%
% SYNTAX: [qlike,tres] = cal_quasi_like_D(param,th,y,s,m,n,c,Pbullet,restrict);
%
% INPUTS:  param ... d x 1 vector of parameter values: in this function only for D!!
%          th    ... model structure; contains the rest of the system.
...
%
% REMARKS:
%         + restrict.det_res: >0: first column of D restricted to the column
%               space of C_1.
...
% extract system from th.
Omega = th.Omega;
A = th.A;
K = th.K;
C = th.C;

% calculate D from parameters respecting potential restrictions defined in
% restrict.
D =  fill_D(param,C(:,1:c),s,m,restrict);
